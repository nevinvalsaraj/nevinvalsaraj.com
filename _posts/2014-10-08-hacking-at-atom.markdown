...
**_Atom(above), a clone of Sublime Text 3(below)_**
**_Both editors have been skinned/styled with external themes & syntax highlighting schemes_**
...
![Atom](https://raw.githubusercontent.com/smashwilson/merge-conflicts/master/docs/conflict-resolution.gif)

**_Merge-conflicts plugin in action in Atom_**
